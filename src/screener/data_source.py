...
_SECTOR_KEYWORDS = [
    ...
    ("반도체", [
        ...
        # specialty 후공정·테스트·소재 (사용자 thesis 직격 — 와이씨/엑시콘/브이엠 등)
        "와이씨", "엑시콘", "브이엠", "케이씨텍", "에이피티씨", "디바이스이엔지",
        "피에스케이", "PSK", "LB세미콘", "한솔케미칼", "이엔에프", "솔브레인홀딩스",
        "오로스테크놀로지", "인텍플러스", "펨트론", "디아이", "동아엘텍", "오킨스",
        "어보브반도체", "가온칩스", "동운아나텍", "라온테크", "미코", "에스에프에이",
        "윈텍", "우진엔텍", "엑사이엔씨", "큐알티", "넥스틴", "마이크로컨텍솔",
        "테크엔",
    ]),
